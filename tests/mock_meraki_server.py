...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Mock Meraki API server for testing"
    )
    parser.add_argument(
        "image_path",
    ...
    print(f"Mock Meraki API Server")
    print(f"=" * 50)
    ...
    print()
    print(f"Endpoints:")
    print(f"  POST http://{args.host}:{args.port}/devices/{{serial}}/camera/generateSnapshot")
